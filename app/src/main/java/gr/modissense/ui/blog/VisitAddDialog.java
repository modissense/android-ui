...
public class VisitAddDialog extends DialogFragment implements DialogInterface.OnClickListener {
    private Blog blog;
    protected Poi point;
    ...
    public VisitAddDialog(){
        ModisSenseApplication.getInstance().inject(this);
    }

    public void init(Poi point, VisitItem visitItem, CreateOrUpdateCallback mapFragment, Blog blog) {
        this.point = point;
    ...
    public Dialog onCreateDialog(Bundle SavedInstanceState) {
        ...
        View dialogView = inflater.inflate(R.layout.visit_add, null);
        ...
        dateText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(VisitAddDialog.this.getFragmentManager(), "datePicker");
            }
        });
        ...
        arrivedText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(VisitAddDialog.this.getFragmentManager(), "timePickerArrive");
            }
        });
        ...
        offText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(VisitAddDialog.this.getFragmentManager(), "timePickerOff");

            }
        });
        seqText = (EditText) dialogView.findViewById(R.id.visitadd_seq);
        seqText.setText(String.valueOf(visitItem.getSeqNum()));
        seqText.setVisibility(View.GONE);
        dialogView.findViewById(R.id.lbl_visitadd_seq).setVisibility(View.GONE);
        ...
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            new SafeAsyncTask<Boolean>() {
                public Boolean call() throws Exception {
                    ModiResult res = service.getService(VisitAddDialog.this.getActivity()).addVisit(poi);
                    Ln.d("Result is :" + res);
                    if (res == null)
                        return false;
                    return res.isResult();
