...
public class PoiAddDialog extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public void init(LatLng point, CreateOrUpdateCallback mapFragment) {
        this.point = point;
        ...
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            new SafeAsyncTask<Poi>() {
                public Poi call() throws Exception {
                    Poi res = service.getService(PoiAddDialog.this.getActivity()).addPoi(poi);
                    Ln.d("Result is :" + res);
                    return res;
                }
